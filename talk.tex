...
\begin{frame}
  ...
  \end{enumerate}
  \begin{itemize}
\arrowitem 1. \& 2. appear to be feasible ways forward until next evaluation
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{minipage}[l]{\linewidth}
    \tc{tableaublue}{\textbf{Impact realization $\lbrace P\rbrace_{j,t}$:}}
        \begin{itemize}
